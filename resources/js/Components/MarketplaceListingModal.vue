...
<template>
    <Modal :show="show" @close="emit('close')" maxWidth="xl">
        <div class="relative overflow-hidden bg-[#0A0A0B] rounded-[2.5rem] border border-white/10 shadow-2xl ring-1 ring-white/5">
            ...
            <!-- Ambient Glow -->
            <div class="absolute -top-32 -right-32 w-64 h-64 bg-[#CBB48A]/10 rounded-full blur-[80px] pointer-events-none"></div>
            ...
            <div class="p-10 relative z-10">
                ...
                <div class="flex flex-col items-center mb-10 text-center">
                    <div class="mb-6 relative w-20 h-20 rounded-3xl bg-gradient-to-br from-[#CBB48A]/10 to-transparent border border-white/10 flex items-center justify-center shadow-inner group overflow-hidden">
                        <div class="absolute inset-0 bg-[#CBB48A]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
                        <svg class="h-8 w-8 text-[#CBB48A] relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                    </div>
                    
                    <h2 class="text-3xl font-black text-white tracking-tight uppercase italic leading-none mb-3">
                        Secure <span class="bg-gradient-to-r from-[#CBB48A] to-teal-400 bg-clip-text text-transparent">Escrow</span>
                    </h2>
                    <div class="flex items-center gap-3 justify-center">
                         <span class="w-1.5 h-1.5 rounded-full bg-[#CBB48A] shadow-[0_0_10px_#CBB48A] animate-pulse"></span>
                        <p class="text-[10px] font-black text-gray-500 uppercase tracking-[0.25em]">Zero-Trust Verification</p>
                    </div>
                </div>

                <!-- Info Box -->
                <div class="bg-[#CBB48A]/5 border border-[#CBB48A]/10 rounded-[1.5rem] p-6 mb-8 relative overflow-hidden group">
                     <div class="absolute left-0 top-0 bottom-0 w-1 bg-[#CBB48A]/20 group-hover:bg-[#CBB48A]/50 transition-colors"></div>
                    <div class="flex gap-5">
                        <div class="shrink-0 mt-0.5">
                            <svg class="h-5 w-5 text-[#CBB48A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <div class="space-y-3">
                             <p class="text-xs text-gray-300 font-medium leading-relaxed">
                                Your intellectual property is protected by our <span class="text-[#CBB48A] font-bold">zero-trust protocol</span>.
                             </p>
                ...
                <div class="mb-6 space-y-3">
                    ...
                    <div class="relative group">
                         <div class="absolute -inset-0.5 bg-gradient-to-r from-[#CBB48A] to-teal-500 rounded-2xl opacity-0 group-focus-within:opacity-20 transition duration-500 blur-sm"></div>
                        <input 
                            v-model="productName"
                            type="text" 
                            class="relative w-full bg-[#050505] border border-white/10 rounded-xl px-5 py-4 text-sm text-gray-200 placeholder-gray-600 focus:outline-none focus:border-[#CBB48A]/50 focus:ring-0 transition-all font-medium tracking-wide"
                ...
                <div class="mb-10 space-y-3">
                    <label class="flex justify-between items-center text-[10px] font-black text-gray-500 uppercase tracking-[0.2em]">
                        ...
                        <span class="text-[#CBB48A]" v-if="price == 0">FREE ASSET</span>
                    </label>
                    <div class="relative group">
                        <div class="absolute -inset-0.5 bg-gradient-to-r from-[#CBB48A] to-teal-500 rounded-2xl opacity-0 group-focus-within:opacity-20 transition duration-500 blur-sm"></div>
                        <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none z-20">
                            <span class="text-[#CBB48A] font-mono text-lg">$</span>
                        </div>
                        <input 
                            ...
                            min="0.00" 
                            step="0.01"
                            class="relative w-full bg-[#050505] border border-white/10 rounded-xl py-4 pl-10 pr-5 text-gray-200 font-mono text-lg focus:outline-none focus:border-[#CBB48A]/50 focus:ring-0 transition-all placeholder-gray-600"
                            placeholder="0.00"
                        />
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    >
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-[#CBB48A]/10 to-teal-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </button>
                </div>
            </div>
        </div>
